...
public class NBTUtils {
    ...
    public static @Nullable String getNBT(@NotNull ItemStack item, String key) {
        ...
        NamespacedKey namespacedKey = new NamespacedKey(Core.get().getPlugin(), key);
    ...
    public static boolean hasNBT(@NotNull ItemStack item, String key) {
        ...
        ItemMeta meta = item.getItemMeta();
        PersistentDataContainer pdc = meta.getPersistentDataContainer();
        return pdc.has(new NamespacedKey(Core.get().getPlugin(), key), PersistentDataType.STRING);
    }
    ...
    public static void removeNBT(@NotNull ItemStack item, String key) {
        ...
        ItemMeta meta = item.getItemMeta();
        PersistentDataContainer pdc = meta.getPersistentDataContainer();
        pdc.remove(new NamespacedKey(Core.get().getPlugin(), key));
        item.setItemMeta(meta);
    }
